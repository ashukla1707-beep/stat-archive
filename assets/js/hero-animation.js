...
(function () {
  ...
  function positionMeanSymbol() {
    ...
    /* Never alter the graph geometry for the mu label. Desktop-site mode on
       phones must keep the exact same SVG size/position as normal desktop. */
    ...
    const gap = touchDesktop ? MU_STYLE.touchDesktopAxisGap : MU_STYLE.axisGap;
    ...
    label.style.setProperty("top", `${y + gap}px`, "important");
    label.style.setProperty("right", "auto", "important");
...
html body .header .hero-probability .axis-mid{display:block!important;visibility:visible!important;opacity:1!important;position:absolute!important;width:auto!important;height:auto!important;z-index:30!important;font-family:Arial,Helvetica,sans-serif!important;font-size:12px!important;font-style:normal!important;font-weight:500!important;line-height:1!important;letter-spacing:0!important;color:#5ee7f7!important;text-shadow:none!important}
html body[data-theme="light"] .header .hero-probability .axis-mid{color:#347d73!important}
@media (pointer:coarse) and (min-width:701px){html body .header .hero-probability .axis-mid{font-size:12px!important;font-weight:500!important;text-shadow:none!important}}
