...
@media(max-width:700px){
  ...
  html[data-authenticated="true"] body .card .card-actions .pv-btn,html[data-authenticated="true"] body .card .card-actions .offline-btn{flex:1 1 0!important;width:auto!important;min-width:0!important;max-width:none!important}
...
html body #previewOverlay.overlay .preview-card.sa-reader-active{width:min(560px,calc((100vw - 28px) * .5))!important;height:min(720px,calc((100dvh - 28px) * .78))!important;max-width:560px!important;max-height:720px!important;margin:auto!important;border-radius:18px!important;overflow:hidden!important;box-shadow:0 24px 70px rgba(0,0,0,.48)!important}
