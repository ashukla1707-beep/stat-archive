...
@media(min-width:701px){
  /* Downloaded is the longest primary action label. Give the centre pill
     extra room on desktop/web so its status text never gets clipped. */
  html body .card .card-actions .pv-btn{flex:0.92 1 0!important}
  html body .card .card-actions .dl-btn,html body .card .card-actions .download-btn{flex:1.22 1 0!important}
  html body .card .card-actions .offline-btn{flex:0.92 1 0!important}
