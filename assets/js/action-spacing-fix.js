(() => {
  ...
  const PURGE_KEY = 'statArchiveCardUiCachePurge20260925NoEntryDownloadV1';
  try {
...
html body .card .card-actions .offline-btn{box-sizing:border-box!important;height:32px!important;min-height:32px!important;padding:0 8px!important;border-radius:8px!important;font-size:11.5px!important;font-weight:650!important;line-height:1!important;gap:4px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important}
@media(max-width:700px){html body .card .card-actions .offline-btn{flex:1 1 0!important;width:0!important;min-width:0!important;max-width:none!important;height:32px!important;min-height:32px!important;padding:0 6px!important;font-size:11px!important;font-weight:700!important;border-radius:8px!important}}
@media(max-width:390px){html body .card .card-actions .offline-btn{height:30px!important;min-height:30px!important;padding:0 4px!important;font-size:9.5px!important}}
...
`;
  ...
  const markThemeSettling=()=>{document.documentElement.classList.add('stat-theme-settling');requestAnimationFrame(()=>requestAnimationFrame(()=>{document.documentElement.classList.remove('stat-theme-settling');void 0}))};
