const CACHE = "stat-archive-shell-v20260905-pdf-preview-v32";
...
const HERO_SELECTION_GUARD_TAG = '<script src="./assets/js/hero-selection-guard.js?v=20260905-6"></script>';
