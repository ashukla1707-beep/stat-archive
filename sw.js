const CACHE = "stat-archive-shell-v20260906-pdf-snapshot-v44";
...
const PDF_PREVIEW_V3_TAG = '<script src="./assets/js/pdf-preview-v3.js?v=20260906-1"></script>';
...
function decorateNavigationHtml(html) {
  ...
  if (!out.includes('assets/js/pdf-preview-v3.js')) out = out.replace('</body>', `${PDF_PREVIEW_V3_TAG}\n</body>`);
  return out;
}
