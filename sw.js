const CACHE = "stat-archive-shell-v20260905-signed-in-spacing-revert-v15";
...
const ACTION_SPACING_FIX_TAG = '<script src="./assets/js/action-spacing-fix.js?v=20260905-8"></script>';
