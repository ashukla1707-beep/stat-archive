const CACHE = "stat-archive-shell-v20260905-archive-divider-label-v18";
...
const ACTION_SPACING_FIX_TAG = '<script src="./assets/js/action-spacing-fix.js?v=20260905-11"></script>';
