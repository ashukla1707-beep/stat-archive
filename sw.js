const CACHE = "stat-archive-shell-v20260915-unified-status-v3";
...
const ACTION_SPACING_FIX_TAG = '<script src="./assets/js/action-spacing-fix.js?v=20260915-unified-status-v3"></script>';
const SPEED_SCRIPT_TAG = '<script src="./assets/js/speed-boost.js?v=20260910-bugfix-3"></script>';
const DOWNLOAD_FIX_TAG = '<script src="./assets/js/download-fix.js?v=20260915-unified-status-v3"></script>';
...
self.addEventListener('fetch', event => {
  ...
  if (url.origin === self.location.origin && url.pathname.startsWith('/api/reviews')) {
  ...
  const isLiveRuntime =
    ...
    url.pathname.endsWith('/assets/js/download-fix.js') ||
    ...
    url.pathname.endsWith('/assets/js/mobile-card-actions.js') ||
